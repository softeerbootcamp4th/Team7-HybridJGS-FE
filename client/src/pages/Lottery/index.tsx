...
export default function Lottery() {
    return (
        <div>
            <section className="h-screen bg-[url('/assets/lottery/electric-line.webp')] bg-no-repeat bg-cover">
                {/* <div className="absolute">
                    <img alt="캐스퍼 봇 아이콘" src="/assets/lottery/casper-bot.webp" />
                </div> */}
                <div className="w-full flex flex-col items-center pt-[280px]">
            ...
            <section className="h-screen">asdfsd</section>
        </div>
    );
}
