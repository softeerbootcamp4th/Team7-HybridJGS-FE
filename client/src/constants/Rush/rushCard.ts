...
export const CARD_OPTIONS: {
    [key: number]: {
        [CARD_TYPE.LEFT_OPTIONS]: { title: string; description: string };
        [CARD_TYPE.RIGHT_OPTIONS]: { title: string; description: string };
    };
} = {
    [CARD_DAYS.DAY1]: {
...
export const CARD_RESULTS: {
    [key: number]: {
        [CARD_TYPE.LEFT_OPTIONS]: { result_title: string; result_description: string };
        [CARD_TYPE.RIGHT_OPTIONS]: { result_title: string; result_description: string };
    };
} = {
    [CARD_DAYS.DAY1]: {
        [CARD_TYPE.LEFT_OPTIONS]: {
